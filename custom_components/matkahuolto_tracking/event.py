...
async def async_setup_entry(
    ...
    async_add_entities([MatkahuoltoPackageEvent(entry.runtime_data)])


class MatkahuoltoPackageEvent(CoordinatorEntity[MatkahuoltoCoordinator], EventEntity):
    ...
    def __init__(self, coordinator: MatkahuoltoCoordinator) -> None:
        ...
        self._attr_unique_id = f"matkahuolto_{username}_package"
